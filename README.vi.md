...
[Tiếng Việt](https://github.com/tuanngp/RynorArch/blob/main/README.vi.md) | [English](https://github.com/tuanngp/RynorArch/blob/main/README.md)
...
- Muốn setup nhanh từ đầu: [Bắt đầu nhanh](https://github.com/tuanngp/RynorArch/blob/main/docs/GETTING_STARTED.md)
- Muốn tích hợp runtime vào startup: [Hướng dẫn tích hợp](https://github.com/tuanngp/RynorArch/blob/main/docs/INTEGRATION_GUIDE.md)
- Muốn xem toàn bộ cờ tính năng: [Ma trận tính năng](https://github.com/tuanngp/RynorArch/blob/main/docs/FEATURE_MATRIX.md)
- Muốn tra attribute: [Tham chiếu attribute](https://github.com/tuanngp/RynorArch/blob/main/docs/ATTRIBUTE_REFERENCE.md)
- Muốn xử lý lỗi nhanh: [Xử lý sự cố](https://github.com/tuanngp/RynorArch/blob/main/docs/TROUBLESHOOTING.md)
- Muốn rollout endpoint an toàn: [Hardening endpoint](https://github.com/tuanngp/RynorArch/blob/main/docs/ENDPOINT_HARDENING.md)
- Muốn vận hành cache: [Vận hành caching](https://github.com/tuanngp/RynorArch/blob/main/docs/CACHING_OPERATIONS.md)
- Muốn test runtime end-to-end: [Kiểm thử runtime](https://github.com/tuanngp/RynorArch/blob/main/docs/RUNTIME_TESTING.md)
- Muốn nâng cấp version: [Nâng cấp](https://github.com/tuanngp/RynorArch/blob/main/docs/UPGRADING.md)
- Muốn migration profile-first: [Nâng cấp profile](https://github.com/tuanngp/RynorArch/blob/main/docs/UPGRADING_PROFILES.md)
- Muốn phát hành package: [Quy trình release](https://github.com/tuanngp/RynorArch/blob/main/docs/RELEASING.md)
- Muốn workflow cho AI agent: [Cẩm nang AI agent](https://github.com/tuanngp/RynorArch/blob/main/docs/AI_AGENT_PLAYBOOK.md)
- Theo dõi thay đổi version: [Changelog](https://github.com/tuanngp/RynorArch/blob/main/CHANGELOG.md)
