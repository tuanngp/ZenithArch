...
using ZenithArch.Generator.Pipeline;
using ZenithArch.Generator.Resolvers;

namespace ZenithArch.Generator;

/// <summary>
/// ZenithArch Incremental Source Generator.
/// 
/// Pipeline:
...
public sealed class ZenithArchGenerator : IIncrementalGenerator
{
    ...
    private static Location? GetArchitectureLocation(Compilation compilation)
    {
        ...
        {
            if (attr.AttributeClass?.ToDisplayString() != "ZenithArch.Abstractions.Attributes.ArchitectureAttribute")
            {
                continue;
            }
