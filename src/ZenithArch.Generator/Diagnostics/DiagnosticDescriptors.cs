...
namespace ZenithArch.Generator.Diagnostics;

/// <summary>
/// Compile-time diagnostic descriptors for the ZenithArch generator.
/// All IDs follow the ZENITH prefix convention.
/// </summary>
internal static class DiagnosticDescriptors
{
    private const string Category = "ZenithArch";
    ...
    public static readonly DiagnosticDescriptor CachingBehaviorNotice = new(
        ...
        messageFormat: "Generated cache behavior stores query responses and emits per-entity invalidation contracts; call AddZenithArchDependencies to register invalidators and cache pipeline behaviors. See docs/CACHING_OPERATIONS.md.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Info,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor SaveModeRequiresGeneratedDi = new(
        ...
        messageFormat: "CqrsSaveMode.PerRequestTransaction is enabled while GenerateDependencyInjection is false; either enable generated DI or manually register IPipelineBehavior<,> with ZenithArchSaveChangesBehavior<,>",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor ValidationRequiresGeneratedDi = new(
        ...
        messageFormat: "EnableValidation is enabled while GenerateDependencyInjection is false; either enable generated DI or manually register IPipelineBehavior<,> with ZenithArchValidationBehavior<,>",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true);
